...
export class ItemsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async endpointItemsGet(offset?: number, limit?: number, page?: number, itemsPerPage?: number, _options?: Configuration): Promise<RequestContext> {
     ...
     */
    public async endpointItemsIdPatch(id: number, itemUpdateSchema: ItemUpdateSchema, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'itemUpdateSchema' is not null or undefined
        if (itemUpdateSchema === null || itemUpdateSchema === undefined) {
            throw new RequiredError("ItemsApi", "endpointItemsIdPatch", "itemUpdateSchema");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(itemUpdateSchema, "ItemUpdateSchema", ""),
            contentType
        );
